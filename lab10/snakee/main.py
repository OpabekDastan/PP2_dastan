...
connection=pgsql.connect(host="localhost", dbname="snakedata", user="postgres",
...
pg.display.set_caption("snakeke")
clock=pg.time.Clock()
shashlyk=pg.image.load("C:/Users/Дастан/Desktop/pp2/lab10/snakee/shashlyk.png").convert_alpha()
qazy=pg.image.load("C:/Users/Дастан/Desktop/pp2/lab10/snakee/qazy.png").convert_alpha()
bg=pg.image.load("C:/Users/Дастан/Desktop/pp2/lab10/snakee/bg.png").convert_alpha()
bgdead=pg.image.load("C:/Users/Дастан/Desktop/pp2/lab10/snakee/bgdead.png").convert_alpha()
icon=pg.image.load("C:/Users/Дастан/Desktop/pp2/lab10/snakee/icon.png").convert_alpha()
pg.display.set_icon(icon)
game_font = pg.font.Font('C:/Users/Дастан/Desktop/pp2/lab10/snakee/Minecraft.ttf', 25)
...
class SNAKE:
    def __init__(self):
        ...
        self.head_up = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/head_up.png').convert_alpha()
        self.head_down = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/head_down.png').convert_alpha()
        self.head_right = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/head_right.png').convert_alpha()
        self.head_left = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/head_left.png').convert_alpha()
		
        self.tail_up = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/tail_up.png').convert_alpha()
        self.tail_down = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/tail_down.png').convert_alpha()
        self.tail_right = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/tail_right.png').convert_alpha()
        self.tail_left = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/tail_left.png').convert_alpha()

        self.body_vertical = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/body_vertical.png').convert_alpha()
        self.body_horizontal = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/body_horizontal.png').convert_alpha()

        self.body_tr = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/body_tr.png').convert_alpha()
        self.body_tl = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/body_tl.png').convert_alpha()
        self.body_br = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/body_br.png').convert_alpha()
        self.body_bl = pg.image.load('C:/Users/Дастан/Desktop/pp2/lab10/snakee/body_bl.png').convert_alpha()
        self.crunch_sound = pg.mixer.Sound('C:/Users/Дастан/Desktop/pp2/lab10/snakee/se_fruit.mp3')
...
class MAIN:
    def __init__(self):
        ...
        self.fruit=FRUIT()
        self.dead=False
        self.dead_sound = pg.mixer.Sound('C:/Users/Дастан/Desktop/pp2/lab10/snakee/se_dead.mp3')
