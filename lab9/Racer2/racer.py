...
bgRoad = pg.image.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/bgRoad.png")
sharkIm = pg.image.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/shark.png")
rocketIm = pg.image.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/rocket.png")
bombIm = pg.image.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/bomb.png")
...
class Cherry(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/cherry.png")
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/coin.png")
        self.rect = self.image.get_rect()
        self.speed = 7
    def move(self):
        global money
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/bomb.png")
        self.rect = self.image.get_rect()
...
class Shark(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/shark.png")
        self.rect = self.image.get_rect()
...
pg.mixer.music.load("/Users/Дастан/Desktop/pp2/lab9/Racer2/bgMusic.mp3")
pg.mixer.music.play()
